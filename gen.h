...
function genArithBlock(name, start) {
	local pad = " " * (3 - #name);
	local reg = start / 8;
	print("#define gen86_", name, "b_r_mod(p_pc, gen_modrm, src_reg, ...)  ", pad, "/" "* ", name, "b", pad, "  %src_reg, ... *" "/ gen_modrm((p_pc, 0, _gen86_putb(p_pc, ", hex2(start), "), src_reg, __VA_ARGS__, _gen86_noop, 0))");
	print("#define gen86_", name, "w_r_mod(p_pc, gen_modrm, src_reg, ...)  ", pad, "/" "* ", name, "w", pad, "  %src_reg, ... *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, ", hex2(start+1), "), src_reg, __VA_ARGS__, _gen86_noop, 0)))");
	print("#define gen86_", name, "l_r_mod(p_pc, gen_modrm, src_reg, ...)  ", pad, "/" "* ", name, "l", pad, "  %src_reg, ... *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, ", hex2(start+1), "), src_reg, __VA_ARGS__, _gen86_noop, 0)))");
	print("#define gen86_", name, "b_mod_r(p_pc, gen_modrm, dst_reg, ...)  ", pad, "/" "* ", name, "b", pad, "  ..., %dst_reg *" "/ gen_modrm((p_pc, 0, _gen86_putb(p_pc, ", hex2(start+2), "), dst_reg, __VA_ARGS__, _gen86_noop, 0))");
	print("#define gen86_", name, "w_mod_r(p_pc, gen_modrm, dst_reg, ...)  ", pad, "/" "* ", name, "w", pad, "  ..., %dst_reg *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, ", hex2(start+3), "), dst_reg, __VA_ARGS__, _gen86_noop, 0)))");
	print("#define gen86_", name, "l_mod_r(p_pc, gen_modrm, dst_reg, ...)  ", pad, "/" "* ", name, "l", pad, "  ..., %dst_reg *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, ", hex2(start+3), "), dst_reg, __VA_ARGS__, _gen86_noop, 0)))");
	...
	print("#define gen86_", name, "b_imm_mod(p_pc, gen_modrm, imm, ...)    ", pad, "/" "* ", name, "b", pad, "  $imm, ...     *" "/ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), ", reg, ", __VA_ARGS__, _gen86_putb(p_pc, imm), 1))");
	print("#define gen86_", name, "b_imm_r(p_pc, imm, dst_reg)             ", pad, "/" "* ", name, "b", pad, "  $imm, %dst_reg*" "/ gen86_", name, "b_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)");
	print("#define gen86_", name, "w_imm16u_mod(p_pc, gen_modrm, imm, ...) ", pad, "/" "* ", name, "w", pad, "  $imm, ...     *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), ", reg, ", __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))");
	print("#define gen86_", name, "w_imm16u_r(p_pc, imm, dst_reg)          ", pad, "/" "* ", name, "w", pad, "  $imm, %dst_reg*" "/ ((dst_reg) == GEN86_R_AX ? gen86_", name, "w_imm_ax(p_pc, imm) : gen86_", name, "w_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))");
	print("#define gen86_", name, "l_imm32s_mod(p_pc, gen_modrm, imm, ...) ", pad, "/" "* ", name, "l", pad, "  $imm, ...     *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), ", reg, ", __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))");
	print("#define gen86_", name, "l_imm32s_r(p_pc, imm, dst_reg)          ", pad, "/" "* ", name, "l", pad, "  $imm, %dst_reg*" "/ ((dst_reg) == GEN86_R_EAX ? gen86_", name, "l_imm_eax(p_pc, imm) : gen86_", name, "l_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))");
	print("#define gen86_", name, "w_imm8s_mod(p_pc, gen_modrm, imm, ...)  ", pad, "/" "* ", name, "w", pad, "  $imm, ...     *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), ", reg, ", __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))");
	print("#define gen86_", name, "w_imm8s_r(p_pc, imm, dst_reg)           ", pad, "/" "* ", name, "w", pad, "  $imm, %dst_reg*" "/ gen86_", name, "w_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)");
	print("#define gen86_", name, "l_imm8s_mod(p_pc, gen_modrm, imm, ...)  ", pad, "/" "* ", name, "l", pad, "  $imm, ...     *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), ", reg, ", __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))");
	print("#define gen86_", name, "l_imm8s_r(p_pc, imm, dst_reg)           ", pad, "/" "* ", name, "l", pad, "  $imm, %dst_reg*" "/ gen86_", name, "l_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)");
	...
	print("#define gen86_", name, "w_imm_r(p_pc, imm, dst_reg)             ", pad, "/" "* ", name, "w", pad, "  $imm, %dst_reg*" "/ (_gen86_fitsb(imm) ? gen86_", name, "w_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_", name, "w_imm16u_r(p_pc, imm, dst_reg))");
	...
	print("#define gen86_", name, "l_imm_r(p_pc, imm, dst_reg)             ", pad, "/" "* ", name, "l", pad, "  $imm, %dst_reg*" "/ (_gen86_fitsb(imm) ? gen86_", name, "l_imm8s_r(p_pc, imm, dst_reg) : gen86_", name, "l_imm32s_r(p_pc, imm, dst_reg))");
	print("#if LIBGEN86_TARGET_BITS == 64");
	print("#define gen86_", name, "q_r_mod(p_pc, gen_modrm, src_reg, ...)  ", pad, "/" "* ", name, "q", pad, "  %src_reg, ... *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, ", hex2(start+1), "), src_reg, __VA_ARGS__, _gen86_noop, 0))");
	print("#define gen86_", name, "q_mod_r(p_pc, gen_modrm, dst_reg, ...)  ", pad, "/" "* ", name, "q", pad, "  ..., %dst_reg *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, ", hex2(start+3), "), dst_reg, __VA_ARGS__, _gen86_noop, 0))");
	...
	print("#define gen86_", name, "q_imm32s_mod(p_pc, gen_modrm, imm, ...) ", pad, "/" "* ", name, "q", pad, "  $imm, ...     *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), ", reg, ", __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))");
	print("#define gen86_", name, "q_imm32s_r(p_pc, imm, dst_reg)          ", pad, "/" "* ", name, "q", pad, "  $imm, %dst_reg*" "/ ((dst_reg) == GEN86_R_RAX ? gen86_", name, "q_imm_rax(p_pc, imm) : gen86_", name, "q_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))");
	print("#define gen86_", name, "q_imm8s_mod(p_pc, gen_modrm, imm, ...)  ", pad, "/" "* ", name, "q", pad, "  $imm, ...     *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), ", reg, ", __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))");
	print("#define gen86_", name, "q_imm8s_r(p_pc, imm, dst_reg)           ", pad, "/" "* ", name, "q", pad, "  $imm, %dst_reg*" "/ gen86_", name, "q_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)");
	...
	print("#define gen86_", name, "q_imm_r(p_pc, imm, dst_reg)             ", pad, "/" "* ", name, "q", pad, "  $imm, %dst_reg*" "/ (_gen86_fitsb(imm) ? gen86_", name, "q_imm8s_r(p_pc, imm, dst_reg) : gen86_", name, "q_imm32s_r(p_pc, imm, dst_reg))");
...
#define gen86_addb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* addb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x00), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_addw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* addw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x01), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_addl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* addl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x01), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_addb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* addb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x02), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_addw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* addw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x03), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_addl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* addl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x03), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_addb_imm_mod(p_pc, gen_modrm, imm, ...)    /* addb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_addb_imm_r(p_pc, imm, dst_reg)             /* addb  $imm, %dst_reg*/ gen86_addb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_addw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* addw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 0, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_addw_imm16u_r(p_pc, imm, dst_reg)          /* addw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_addw_imm_ax(p_pc, imm) : gen86_addw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_addl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* addl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 0, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_addl_imm32s_r(p_pc, imm, dst_reg)          /* addl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_addl_imm_eax(p_pc, imm) : gen86_addl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_addw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* addw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 0, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_addw_imm8s_r(p_pc, imm, dst_reg)           /* addw  $imm, %dst_reg*/ gen86_addw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_addl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* addl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 0, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_addl_imm8s_r(p_pc, imm, dst_reg)           /* addl  $imm, %dst_reg*/ gen86_addl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_addw_imm_r(p_pc, imm, dst_reg)             /* addw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_addw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_addw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_addl_imm_r(p_pc, imm, dst_reg)             /* addl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_addl_imm8s_r(p_pc, imm, dst_reg) : gen86_addl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_addq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* addq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x01), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_addq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* addq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x03), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_addq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* addq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 0, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_addq_imm32s_r(p_pc, imm, dst_reg)          /* addq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_addq_imm_rax(p_pc, imm) : gen86_addq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_addq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* addq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 0, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_addq_imm8s_r(p_pc, imm, dst_reg)           /* addq  $imm, %dst_reg*/ gen86_addq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_addq_imm_r(p_pc, imm, dst_reg)             /* addq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_addq_imm8s_r(p_pc, imm, dst_reg) : gen86_addq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_orb_r_mod(p_pc, gen_modrm, src_reg, ...)   /* orb   %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x08), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_orw_r_mod(p_pc, gen_modrm, src_reg, ...)   /* orw   %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x09), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_orl_r_mod(p_pc, gen_modrm, src_reg, ...)   /* orl   %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x09), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_orb_mod_r(p_pc, gen_modrm, dst_reg, ...)   /* orb   ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x0a), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_orw_mod_r(p_pc, gen_modrm, dst_reg, ...)   /* orw   ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x0b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_orl_mod_r(p_pc, gen_modrm, dst_reg, ...)   /* orl   ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x0b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_orb_imm_mod(p_pc, gen_modrm, imm, ...)     /* orb   $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 1, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_orb_imm_r(p_pc, imm, dst_reg)              /* orb   $imm, %dst_reg*/ gen86_orb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_orw_imm16u_mod(p_pc, gen_modrm, imm, ...)  /* orw   $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 1, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_orw_imm16u_r(p_pc, imm, dst_reg)           /* orw   $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_orw_imm_ax(p_pc, imm) : gen86_orw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_orl_imm32s_mod(p_pc, gen_modrm, imm, ...)  /* orl   $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 1, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_orl_imm32s_r(p_pc, imm, dst_reg)           /* orl   $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_orl_imm_eax(p_pc, imm) : gen86_orl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_orw_imm8s_mod(p_pc, gen_modrm, imm, ...)   /* orw   $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 1, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_orw_imm8s_r(p_pc, imm, dst_reg)            /* orw   $imm, %dst_reg*/ gen86_orw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_orl_imm8s_mod(p_pc, gen_modrm, imm, ...)   /* orl   $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 1, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_orl_imm8s_r(p_pc, imm, dst_reg)            /* orl   $imm, %dst_reg*/ gen86_orl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_orw_imm_r(p_pc, imm, dst_reg)              /* orw   $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_orw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_orw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_orl_imm_r(p_pc, imm, dst_reg)              /* orl   $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_orl_imm8s_r(p_pc, imm, dst_reg) : gen86_orl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_orq_r_mod(p_pc, gen_modrm, src_reg, ...)   /* orq   %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x09), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_orq_mod_r(p_pc, gen_modrm, dst_reg, ...)   /* orq   ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x0b), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_orq_imm32s_mod(p_pc, gen_modrm, imm, ...)  /* orq   $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 1, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_orq_imm32s_r(p_pc, imm, dst_reg)           /* orq   $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_orq_imm_rax(p_pc, imm) : gen86_orq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_orq_imm8s_mod(p_pc, gen_modrm, imm, ...)   /* orq   $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 1, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_orq_imm8s_r(p_pc, imm, dst_reg)            /* orq   $imm, %dst_reg*/ gen86_orq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_orq_imm_r(p_pc, imm, dst_reg)              /* orq   $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_orq_imm8s_r(p_pc, imm, dst_reg) : gen86_orq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_adcb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* adcb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x10), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_adcw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* adcw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x11), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_adcl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* adcl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x11), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_adcb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* adcb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x12), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_adcw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* adcw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x13), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_adcl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* adcl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x13), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_adcb_imm_mod(p_pc, gen_modrm, imm, ...)    /* adcb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 2, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_adcb_imm_r(p_pc, imm, dst_reg)             /* adcb  $imm, %dst_reg*/ gen86_adcb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_adcw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* adcw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 2, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_adcw_imm16u_r(p_pc, imm, dst_reg)          /* adcw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_adcw_imm_ax(p_pc, imm) : gen86_adcw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_adcl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* adcl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 2, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_adcl_imm32s_r(p_pc, imm, dst_reg)          /* adcl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_adcl_imm_eax(p_pc, imm) : gen86_adcl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_adcw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* adcw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 2, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_adcw_imm8s_r(p_pc, imm, dst_reg)           /* adcw  $imm, %dst_reg*/ gen86_adcw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_adcl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* adcl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 2, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_adcl_imm8s_r(p_pc, imm, dst_reg)           /* adcl  $imm, %dst_reg*/ gen86_adcl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_adcw_imm_r(p_pc, imm, dst_reg)             /* adcw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_adcw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_adcw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_adcl_imm_r(p_pc, imm, dst_reg)             /* adcl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_adcl_imm8s_r(p_pc, imm, dst_reg) : gen86_adcl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_adcq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* adcq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x11), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_adcq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* adcq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x13), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_adcq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* adcq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 2, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_adcq_imm32s_r(p_pc, imm, dst_reg)          /* adcq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_adcq_imm_rax(p_pc, imm) : gen86_adcq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_adcq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* adcq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 2, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_adcq_imm8s_r(p_pc, imm, dst_reg)           /* adcq  $imm, %dst_reg*/ gen86_adcq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_adcq_imm_r(p_pc, imm, dst_reg)             /* adcq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_adcq_imm8s_r(p_pc, imm, dst_reg) : gen86_adcq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_sbbb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* sbbb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x18), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sbbw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* sbbw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x19), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sbbl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* sbbl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x19), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sbbb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* sbbb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x1a), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sbbw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* sbbw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x1b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sbbl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* sbbl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x1b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_sbbb_imm_mod(p_pc, gen_modrm, imm, ...)    /* sbbb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 3, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_sbbb_imm_r(p_pc, imm, dst_reg)             /* sbbb  $imm, %dst_reg*/ gen86_sbbb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_sbbw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* sbbw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 3, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_sbbw_imm16u_r(p_pc, imm, dst_reg)          /* sbbw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_sbbw_imm_ax(p_pc, imm) : gen86_sbbw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_sbbl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* sbbl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 3, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_sbbl_imm32s_r(p_pc, imm, dst_reg)          /* sbbl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_sbbl_imm_eax(p_pc, imm) : gen86_sbbl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_sbbw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* sbbw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 3, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_sbbw_imm8s_r(p_pc, imm, dst_reg)           /* sbbw  $imm, %dst_reg*/ gen86_sbbw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_sbbl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* sbbl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 3, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_sbbl_imm8s_r(p_pc, imm, dst_reg)           /* sbbl  $imm, %dst_reg*/ gen86_sbbl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_sbbw_imm_r(p_pc, imm, dst_reg)             /* sbbw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_sbbw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_sbbw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_sbbl_imm_r(p_pc, imm, dst_reg)             /* sbbl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_sbbl_imm8s_r(p_pc, imm, dst_reg) : gen86_sbbl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_sbbq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* sbbq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x19), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sbbq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* sbbq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x1b), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_sbbq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* sbbq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 3, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_sbbq_imm32s_r(p_pc, imm, dst_reg)          /* sbbq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_sbbq_imm_rax(p_pc, imm) : gen86_sbbq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_sbbq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* sbbq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 3, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_sbbq_imm8s_r(p_pc, imm, dst_reg)           /* sbbq  $imm, %dst_reg*/ gen86_sbbq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_sbbq_imm_r(p_pc, imm, dst_reg)             /* sbbq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_sbbq_imm8s_r(p_pc, imm, dst_reg) : gen86_sbbq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_andb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* andb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x20), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_andw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* andw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x21), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_andl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* andl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x21), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_andb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* andb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x22), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_andw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* andw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x23), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_andl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* andl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x23), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_andb_imm_mod(p_pc, gen_modrm, imm, ...)    /* andb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_andb_imm_r(p_pc, imm, dst_reg)             /* andb  $imm, %dst_reg*/ gen86_andb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_andw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* andw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 4, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_andw_imm16u_r(p_pc, imm, dst_reg)          /* andw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_andw_imm_ax(p_pc, imm) : gen86_andw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_andl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* andl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 4, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_andl_imm32s_r(p_pc, imm, dst_reg)          /* andl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_andl_imm_eax(p_pc, imm) : gen86_andl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_andw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* andw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 4, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_andw_imm8s_r(p_pc, imm, dst_reg)           /* andw  $imm, %dst_reg*/ gen86_andw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_andl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* andl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 4, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_andl_imm8s_r(p_pc, imm, dst_reg)           /* andl  $imm, %dst_reg*/ gen86_andl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_andw_imm_r(p_pc, imm, dst_reg)             /* andw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_andw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_andw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_andl_imm_r(p_pc, imm, dst_reg)             /* andl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_andl_imm8s_r(p_pc, imm, dst_reg) : gen86_andl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_andq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* andq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x21), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_andq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* andq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x23), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_andq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* andq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 4, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_andq_imm32s_r(p_pc, imm, dst_reg)          /* andq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_andq_imm_rax(p_pc, imm) : gen86_andq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_andq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* andq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 4, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_andq_imm8s_r(p_pc, imm, dst_reg)           /* andq  $imm, %dst_reg*/ gen86_andq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_andq_imm_r(p_pc, imm, dst_reg)             /* andq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_andq_imm8s_r(p_pc, imm, dst_reg) : gen86_andq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_subb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* subb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x28), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_subw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* subw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x29), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_subl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* subl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x29), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_subb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* subb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x2a), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_subw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* subw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x2b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_subl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* subl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x2b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_subb_imm_mod(p_pc, gen_modrm, imm, ...)    /* subb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_subb_imm_r(p_pc, imm, dst_reg)             /* subb  $imm, %dst_reg*/ gen86_subb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_subw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* subw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 5, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_subw_imm16u_r(p_pc, imm, dst_reg)          /* subw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_subw_imm_ax(p_pc, imm) : gen86_subw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_subl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* subl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 5, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_subl_imm32s_r(p_pc, imm, dst_reg)          /* subl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_subl_imm_eax(p_pc, imm) : gen86_subl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_subw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* subw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 5, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_subw_imm8s_r(p_pc, imm, dst_reg)           /* subw  $imm, %dst_reg*/ gen86_subw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_subl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* subl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 5, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_subl_imm8s_r(p_pc, imm, dst_reg)           /* subl  $imm, %dst_reg*/ gen86_subl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_subw_imm_r(p_pc, imm, dst_reg)             /* subw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_subw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_subw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_subl_imm_r(p_pc, imm, dst_reg)             /* subl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_subl_imm8s_r(p_pc, imm, dst_reg) : gen86_subl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_subq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* subq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x29), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_subq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* subq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x2b), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_subq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* subq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 5, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_subq_imm32s_r(p_pc, imm, dst_reg)          /* subq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_subq_imm_rax(p_pc, imm) : gen86_subq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_subq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* subq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 5, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_subq_imm8s_r(p_pc, imm, dst_reg)           /* subq  $imm, %dst_reg*/ gen86_subq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_subq_imm_r(p_pc, imm, dst_reg)             /* subq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_subq_imm8s_r(p_pc, imm, dst_reg) : gen86_subq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_xorb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* xorb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x30), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xorw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* xorw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x31), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_xorl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* xorl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x31), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_xorb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* xorb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x32), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xorw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* xorw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x33), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_xorl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* xorl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x33), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_xorb_imm_mod(p_pc, gen_modrm, imm, ...)    /* xorb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_xorb_imm_r(p_pc, imm, dst_reg)             /* xorb  $imm, %dst_reg*/ gen86_xorb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_xorw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* xorw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 6, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_xorw_imm16u_r(p_pc, imm, dst_reg)          /* xorw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_xorw_imm_ax(p_pc, imm) : gen86_xorw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_xorl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* xorl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 6, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_xorl_imm32s_r(p_pc, imm, dst_reg)          /* xorl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_xorl_imm_eax(p_pc, imm) : gen86_xorl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_xorw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* xorw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 6, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_xorw_imm8s_r(p_pc, imm, dst_reg)           /* xorw  $imm, %dst_reg*/ gen86_xorw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_xorl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* xorl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 6, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_xorl_imm8s_r(p_pc, imm, dst_reg)           /* xorl  $imm, %dst_reg*/ gen86_xorl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_xorw_imm_r(p_pc, imm, dst_reg)             /* xorw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_xorw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_xorw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_xorl_imm_r(p_pc, imm, dst_reg)             /* xorl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_xorl_imm8s_r(p_pc, imm, dst_reg) : gen86_xorl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_xorq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* xorq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x31), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xorq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* xorq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x33), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_xorq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* xorq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 6, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_xorq_imm32s_r(p_pc, imm, dst_reg)          /* xorq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_xorq_imm_rax(p_pc, imm) : gen86_xorq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_xorq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* xorq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 6, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_xorq_imm8s_r(p_pc, imm, dst_reg)           /* xorq  $imm, %dst_reg*/ gen86_xorq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_xorq_imm_r(p_pc, imm, dst_reg)             /* xorq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_xorq_imm8s_r(p_pc, imm, dst_reg) : gen86_xorq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_cmpb_r_mod(p_pc, gen_modrm, src_reg, ...)  /* cmpb  %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x38), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_cmpw_r_mod(p_pc, gen_modrm, src_reg, ...)  /* cmpw  %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x39), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_cmpl_r_mod(p_pc, gen_modrm, src_reg, ...)  /* cmpl  %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x39), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_cmpb_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* cmpb  ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x3a), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_cmpw_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* cmpw  ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x3b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_cmpl_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* cmpl  ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x3b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
...
#define gen86_cmpb_imm_mod(p_pc, gen_modrm, imm, ...)    /* cmpb  $imm, ...     */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x80), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_cmpb_imm_r(p_pc, imm, dst_reg)             /* cmpb  $imm, %dst_reg*/ gen86_cmpb_imm_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_cmpw_imm16u_mod(p_pc, gen_modrm, imm, ...) /* cmpw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 7, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_cmpw_imm16u_r(p_pc, imm, dst_reg)          /* cmpw  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_AX ? gen86_cmpw_imm_ax(p_pc, imm) : gen86_cmpw_imm16u_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_cmpl_imm32s_mod(p_pc, gen_modrm, imm, ...) /* cmpl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x81), 7, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_cmpl_imm32s_r(p_pc, imm, dst_reg)          /* cmpl  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_EAX ? gen86_cmpl_imm_eax(p_pc, imm) : gen86_cmpl_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_cmpw_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* cmpw  $imm, ...     */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 7, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_cmpw_imm8s_r(p_pc, imm, dst_reg)           /* cmpw  $imm, %dst_reg*/ gen86_cmpw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
#define gen86_cmpl_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* cmpl  $imm, ...     */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x83), 7, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_cmpl_imm8s_r(p_pc, imm, dst_reg)           /* cmpl  $imm, %dst_reg*/ gen86_cmpl_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_cmpw_imm_r(p_pc, imm, dst_reg)             /* cmpw  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_cmpw_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg) : gen86_cmpw_imm16u_r(p_pc, imm, dst_reg))
...
#define gen86_cmpl_imm_r(p_pc, imm, dst_reg)             /* cmpl  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_cmpl_imm8s_r(p_pc, imm, dst_reg) : gen86_cmpl_imm32s_r(p_pc, imm, dst_reg))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_cmpq_r_mod(p_pc, gen_modrm, src_reg, ...)  /* cmpq  %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x39), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_cmpq_mod_r(p_pc, gen_modrm, dst_reg, ...)  /* cmpq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x3b), dst_reg, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_cmpq_imm32s_mod(p_pc, gen_modrm, imm, ...) /* cmpq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x81), 7, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_cmpq_imm32s_r(p_pc, imm, dst_reg)          /* cmpq  $imm, %dst_reg*/ ((dst_reg) == GEN86_R_RAX ? gen86_cmpq_imm_rax(p_pc, imm) : gen86_cmpq_imm32s_mod(p_pc, gen86_modrm_r, imm, dst_reg))
#define gen86_cmpq_imm8s_mod(p_pc, gen_modrm, imm, ...)  /* cmpq  $imm, ...     */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x83), 7, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#define gen86_cmpq_imm8s_r(p_pc, imm, dst_reg)           /* cmpq  $imm, %dst_reg*/ gen86_cmpq_imm8s_mod(p_pc, gen86_modrm_r, imm, dst_reg)
...
#define gen86_cmpq_imm_r(p_pc, imm, dst_reg)             /* cmpq  $imm, %dst_reg*/ (_gen86_fitsb(imm) ? gen86_cmpq_imm8s_r(p_pc, imm, dst_reg) : gen86_cmpq_imm32s_r(p_pc, imm, dst_reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
/*[[[end]]]*/
...
#define gen86_movslq_mod_r(p_pc, gen_modrm, dst_reg, ...) /* movslq  ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x63), src_reg, __VA_ARGS__, _gen86_noop, 0))
#else /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_boundw(p_pc, gen_modrm, test_reg, ...) /* boundw ..., %test_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x62), test_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_boundl(p_pc, gen_modrm, test_reg, ...) /* boundl ..., %test_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x62), test_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_arpl(p_pc, gen_modrm, reg, ...)        /* arpl   %reg, ...      */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x63), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS != 64 */
...
#define gen86_imulw_imm_mod_r(p_pc, gen_modrm, imm, dst_reg, ...)   /* imulw $imm, ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x69), dst_reg, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_imulw_imm8s_mod_r(p_pc, gen_modrm, imm, dst_reg, ...) /* imulw $imm, ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x6b), dst_reg, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#define gen86_imull_imm_mod_r(p_pc, gen_modrm, imm, dst_reg, ...)   /* imull $imm, ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x69), dst_reg, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#define gen86_imull_imm8s_mod_r(p_pc, gen_modrm, imm, dst_reg, ...) /* imull $imm, ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x6b), dst_reg, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_imulq_imm_mod_r(p_pc, gen_modrm, imm, dst_reg, ...)   /* imulq $imm, ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x69), dst_reg, __VA_ARGS__, _gen86_putsl(p_pc, imm), 4))
#define gen86_imulq_imm8s_mod_r(p_pc, gen_modrm, imm, dst_reg, ...) /* imulq $imm, ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x6b), dst_reg, __VA_ARGS__, _gen86_putsb(p_pc, imm), 1))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_testb_r_mod(p_pc, gen_modrm, r1, ...) /* testb %r1, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x84), r1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_testw_r_mod(p_pc, gen_modrm, r1, ...) /* testw %r1, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x85), r1, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_testl_r_mod(p_pc, gen_modrm, r1, ...) /* testl %r1, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x85), r1, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_testq_r_mod(p_pc, gen_modrm, r1, ...) /* testq %r1, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x85), r1, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_xchgb_r_mod(p_pc, gen_modrm, r1, ...) /* xchgb %r1, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x86), r1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xchgw_r_mod(p_pc, gen_modrm, r1, ...) /* xchgw %r1, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x87), r1, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_xchgl_r_mod(p_pc, gen_modrm, r1, ...) /* xchgl %r1, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x87), r1, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_xchgq_r_mod(p_pc, gen_modrm, r1, ...) /* xchgq %r1, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x87), r1, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_movb_r_mod(p_pc, gen_modrm, src_reg, ...) /* movb %src_reg, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x88), src_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_movw_r_mod(p_pc, gen_modrm, src_reg, ...) /* movw %src_reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x89), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movl_r_mod(p_pc, gen_modrm, src_reg, ...) /* movl %src_reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x89), src_reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movq_r_mod(p_pc, gen_modrm, src_reg, ...) /* movq %src_reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x89), src_reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_movb_mod_r(p_pc, gen_modrm, dst_reg, ...) /* movb ..., %dst_reg */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8a), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_movw_mod_r(p_pc, gen_modrm, dst_reg, ...) /* movw ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movl_mod_r(p_pc, gen_modrm, dst_reg, ...) /* movl ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8b), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movq_mod_r(p_pc, gen_modrm, dst_reg, ...) /* movq ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x8b), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_movw_sgr_mod(p_pc, gen_modrm, src_sgreg, ...) /* movw %src_sgreg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8c), src_sgreg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movl_sgr_mod(p_pc, gen_modrm, src_sgreg, ...) /* movl %src_sgreg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8c), src_sgreg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movq_sgr_mod(p_pc, gen_modrm, src_sgreg, ...) /* movq %src_sgreg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x8c), src_sgreg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_movw_mod_sgr(p_pc, gen_modrm, dst_sgreg, ...) /* movw ..., %dst_sgreg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8e), dst_sgreg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movl_mod_sgr(p_pc, gen_modrm, dst_sgreg, ...) /* movl ..., %dst_sgreg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8e), dst_sgreg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movq_mod_sgr(p_pc, gen_modrm, dst_sgreg, ...) /* movq ..., %dst_sgreg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x8e), dst_sgreg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_leaw_mod_r(p_pc, gen_modrm, dst_reg, ...) /* leaw ..., %dst_reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8d), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_leal_mod_r(p_pc, gen_modrm, dst_reg, ...) /* leal ..., %dst_reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8d), dst_reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_leaq_mod_r(p_pc, gen_modrm, dst_reg, ...) /* leaq ..., %dst_reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x8d), dst_reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_popw_mod(p_pc, gen_modrm, ...) /* popw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8f), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_popl_mod(p_pc, gen_modrm, ...) /* popl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0x8f), 0, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_popq_mod(p_pc, gen_modrm, ...) /* popq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0x8f), 0, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_testb_imm_r(p_pc, imm, reg) /* testb $imm, %reg */ ((reg) == GEN86_R_AL ? gen86_testb_imm_al(p_pc, imm) : gen86_testb_imm_mod(p_pc, gen86_modrm_r, imm, reg))
...
#define gen86_testw_imm_r(p_pc, imm, reg) /* testw $imm, %reg */ ((reg) == GEN86_R_AX ? gen86_testw_imm_ax(p_pc, imm) : gen86_testw_imm_mod(p_pc, gen86_modrm_r, imm, reg))
...
#define gen86_testl_imm_r(p_pc, imm, reg) /* testl $imm, %reg */ ((reg) == GEN86_R_EAX ? gen86_testl_imm_eax(p_pc, imm) : gen86_testl_imm_mod(p_pc, gen86_modrm_r, imm, reg))
#if LIBGEN86_TARGET_BITS == 64
...
#define gen86_testq_imm_r(p_pc, imm, reg) /* testq $imm, %reg */ ((reg) == GEN86_R_RAX ? gen86_testq_imm_rax(p_pc, imm) : gen86_testq_imm_mod(p_pc, gen86_modrm_r, imm, reg))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
function genShift(name, reg) {
	print("#define gen86_", name, "b_imm_mod(p_pc, gen_modrm, imm, ...) /" "* ", name, "b $imm, ... *" "/ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), ", reg, ", __VA_ARGS__, _gen86_putb(p_pc, imm), 1))");
	print("#define gen86_", name, "w_imm_mod(p_pc, gen_modrm, imm, ...) /" "* ", name, "w $imm, ... *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), ", reg, ", __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))");
	print("#define gen86_", name, "l_imm_mod(p_pc, gen_modrm, imm, ...) /" "* ", name, "l $imm, ... *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), ", reg, ", __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))");
	print("#define gen86_", name, "b_1_mod(p_pc, gen_modrm, ...)        /" "* ", name, "b $1,   ... *" "/ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), ", reg, ", __VA_ARGS__, _gen86_noop, 0))");
	print("#define gen86_", name, "w_1_mod(p_pc, gen_modrm, ...)        /" "* ", name, "w $1,   ... *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), ", reg, ", __VA_ARGS__, _gen86_noop, 0)))");
	print("#define gen86_", name, "l_1_mod(p_pc, gen_modrm, ...)        /" "* ", name, "l $1,   ... *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), ", reg, ", __VA_ARGS__, _gen86_noop, 0)))");
	print("#define gen86_", name, "b_cl_mod(p_pc, gen_modrm, ...)       /" "* ", name, "b %cl,  ... *" "/ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), ", reg, ", __VA_ARGS__, _gen86_noop, 0))");
	print("#define gen86_", name, "w_cl_mod(p_pc, gen_modrm, ...)       /" "* ", name, "w %cl,  ... *" "/ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), ", reg, ", __VA_ARGS__, _gen86_noop, 0)))");
	print("#define gen86_", name, "l_cl_mod(p_pc, gen_modrm, ...)       /" "* ", name, "l %cl,  ... *" "/ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), ", reg, ", __VA_ARGS__, _gen86_noop, 0)))");
	print("#if LIBGEN86_TARGET_BITS == 64");
	print("#define gen86_", name, "q_imm_mod(p_pc, gen_modrm, imm, ...) /" "* ", name, "q $imm, ... *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), ", reg, ", __VA_ARGS__, _gen86_putb(p_pc, imm), 1))");
	print("#define gen86_", name, "q_1_mod(p_pc, gen_modrm, ...)        /" "* ", name, "q $1,   ... *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), ", reg, ", __VA_ARGS__, _gen86_noop, 0))");
	print("#define gen86_", name, "q_cl_mod(p_pc, gen_modrm, ...)       /" "* ", name, "q %cl,  ... *" "/ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), ", reg, ", __VA_ARGS__, _gen86_noop, 0))");
	print("#endif /" "* LIBGEN86_TARGET_BITS == 64 *" "/");
}
genShift("rol", 0);
genShift("ror", 1);
...
#define gen86_rolb_imm_mod(p_pc, gen_modrm, imm, ...) /* rolb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rolw_imm_mod(p_pc, gen_modrm, imm, ...) /* rolw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_roll_imm_mod(p_pc, gen_modrm, imm, ...) /* roll $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rolb_1_mod(p_pc, gen_modrm, ...)        /* rolb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rolw_1_mod(p_pc, gen_modrm, ...)        /* rolw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_roll_1_mod(p_pc, gen_modrm, ...)        /* roll $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rolb_cl_mod(p_pc, gen_modrm, ...)       /* rolb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rolw_cl_mod(p_pc, gen_modrm, ...)       /* rolw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_roll_cl_mod(p_pc, gen_modrm, ...)       /* roll %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 0, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_rolq_imm_mod(p_pc, gen_modrm, imm, ...) /* rolq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rolq_1_mod(p_pc, gen_modrm, ...)        /* rolq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rolq_cl_mod(p_pc, gen_modrm, ...)       /* rolq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 0, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_rorb_imm_mod(p_pc, gen_modrm, imm, ...) /* rorb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 1, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rorw_imm_mod(p_pc, gen_modrm, imm, ...) /* rorw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 1, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rorl_imm_mod(p_pc, gen_modrm, imm, ...) /* rorl $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 1, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rorb_1_mod(p_pc, gen_modrm, ...)        /* rorb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rorw_1_mod(p_pc, gen_modrm, ...)        /* rorw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 1, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rorl_1_mod(p_pc, gen_modrm, ...)        /* rorl $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 1, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rorb_cl_mod(p_pc, gen_modrm, ...)       /* rorb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rorw_cl_mod(p_pc, gen_modrm, ...)       /* rorw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 1, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rorl_cl_mod(p_pc, gen_modrm, ...)       /* rorl %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 1, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_rorq_imm_mod(p_pc, gen_modrm, imm, ...) /* rorq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 1, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rorq_1_mod(p_pc, gen_modrm, ...)        /* rorq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rorq_cl_mod(p_pc, gen_modrm, ...)       /* rorq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 1, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_rclb_imm_mod(p_pc, gen_modrm, imm, ...) /* rclb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 2, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rclw_imm_mod(p_pc, gen_modrm, imm, ...) /* rclw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 2, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rcll_imm_mod(p_pc, gen_modrm, imm, ...) /* rcll $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 2, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rclb_1_mod(p_pc, gen_modrm, ...)        /* rclb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rclw_1_mod(p_pc, gen_modrm, ...)        /* rclw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rcll_1_mod(p_pc, gen_modrm, ...)        /* rcll $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rclb_cl_mod(p_pc, gen_modrm, ...)       /* rclb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rclw_cl_mod(p_pc, gen_modrm, ...)       /* rclw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rcll_cl_mod(p_pc, gen_modrm, ...)       /* rcll %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 2, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_rclq_imm_mod(p_pc, gen_modrm, imm, ...) /* rclq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 2, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rclq_1_mod(p_pc, gen_modrm, ...)        /* rclq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rclq_cl_mod(p_pc, gen_modrm, ...)       /* rclq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 2, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_rcrb_imm_mod(p_pc, gen_modrm, imm, ...) /* rcrb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 3, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rcrw_imm_mod(p_pc, gen_modrm, imm, ...) /* rcrw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 3, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rcrl_imm_mod(p_pc, gen_modrm, imm, ...) /* rcrl $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 3, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_rcrb_1_mod(p_pc, gen_modrm, ...)        /* rcrb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rcrw_1_mod(p_pc, gen_modrm, ...)        /* rcrw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rcrl_1_mod(p_pc, gen_modrm, ...)        /* rcrl $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rcrb_cl_mod(p_pc, gen_modrm, ...)       /* rcrb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rcrw_cl_mod(p_pc, gen_modrm, ...)       /* rcrw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rcrl_cl_mod(p_pc, gen_modrm, ...)       /* rcrl %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 3, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_rcrq_imm_mod(p_pc, gen_modrm, imm, ...) /* rcrq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 3, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_rcrq_1_mod(p_pc, gen_modrm, ...)        /* rcrq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rcrq_cl_mod(p_pc, gen_modrm, ...)       /* rcrq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 3, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_shlb_imm_mod(p_pc, gen_modrm, imm, ...) /* shlb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_shlw_imm_mod(p_pc, gen_modrm, imm, ...) /* shlw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shll_imm_mod(p_pc, gen_modrm, imm, ...) /* shll $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shlb_1_mod(p_pc, gen_modrm, ...)        /* shlb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_shlw_1_mod(p_pc, gen_modrm, ...)        /* shlw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shll_1_mod(p_pc, gen_modrm, ...)        /* shll $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shlb_cl_mod(p_pc, gen_modrm, ...)       /* shlb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_shlw_cl_mod(p_pc, gen_modrm, ...)       /* shlw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shll_cl_mod(p_pc, gen_modrm, ...)       /* shll %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 4, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_shlq_imm_mod(p_pc, gen_modrm, imm, ...) /* shlq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_shlq_1_mod(p_pc, gen_modrm, ...)        /* shlq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_shlq_cl_mod(p_pc, gen_modrm, ...)       /* shlq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 4, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_shrb_imm_mod(p_pc, gen_modrm, imm, ...) /* shrb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_shrw_imm_mod(p_pc, gen_modrm, imm, ...) /* shrw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shrl_imm_mod(p_pc, gen_modrm, imm, ...) /* shrl $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shrb_1_mod(p_pc, gen_modrm, ...)        /* shrb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_shrw_1_mod(p_pc, gen_modrm, ...)        /* shrw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shrl_1_mod(p_pc, gen_modrm, ...)        /* shrl $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shrb_cl_mod(p_pc, gen_modrm, ...)       /* shrb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_shrw_cl_mod(p_pc, gen_modrm, ...)       /* shrw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shrl_cl_mod(p_pc, gen_modrm, ...)       /* shrl %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 5, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_shrq_imm_mod(p_pc, gen_modrm, imm, ...) /* shrq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_shrq_1_mod(p_pc, gen_modrm, ...)        /* shrq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_shrq_cl_mod(p_pc, gen_modrm, ...)       /* shrq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 5, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_salb_imm_mod(p_pc, gen_modrm, imm, ...) /* salb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_salw_imm_mod(p_pc, gen_modrm, imm, ...) /* salw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_sall_imm_mod(p_pc, gen_modrm, imm, ...) /* sall $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_salb_1_mod(p_pc, gen_modrm, ...)        /* salb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_salw_1_mod(p_pc, gen_modrm, ...)        /* salw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sall_1_mod(p_pc, gen_modrm, ...)        /* sall $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_salb_cl_mod(p_pc, gen_modrm, ...)       /* salb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_salw_cl_mod(p_pc, gen_modrm, ...)       /* salw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sall_cl_mod(p_pc, gen_modrm, ...)       /* sall %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 6, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_salq_imm_mod(p_pc, gen_modrm, imm, ...) /* salq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_salq_1_mod(p_pc, gen_modrm, ...)        /* salq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_salq_cl_mod(p_pc, gen_modrm, ...)       /* salq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 6, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_sarb_imm_mod(p_pc, gen_modrm, imm, ...) /* sarb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc0), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_sarw_imm_mod(p_pc, gen_modrm, imm, ...) /* sarw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_sarl_imm_mod(p_pc, gen_modrm, imm, ...) /* sarl $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc1), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_sarb_1_mod(p_pc, gen_modrm, ...)        /* sarb $1,   ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd0), 7, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sarw_1_mod(p_pc, gen_modrm, ...)        /* sarw $1,   ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sarl_1_mod(p_pc, gen_modrm, ...)        /* sarl $1,   ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd1), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sarb_cl_mod(p_pc, gen_modrm, ...)       /* sarb %cl,  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd2), 7, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sarw_cl_mod(p_pc, gen_modrm, ...)       /* sarw %cl,  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_sarl_cl_mod(p_pc, gen_modrm, ...)       /* sarl %cl,  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xd3), 7, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_sarq_imm_mod(p_pc, gen_modrm, imm, ...) /* sarq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc1), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_sarq_1_mod(p_pc, gen_modrm, ...)        /* sarq $1,   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd1), 7, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sarq_cl_mod(p_pc, gen_modrm, ...)       /* sarq %cl,  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xd3), 7, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
/*[[[end]]]*/
...
#define gen86_movb_imm_mod(p_pc, gen_modrm, imm, ...) /* movb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc6), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_movw_imm_mod(p_pc, gen_modrm, imm, ...) /* movw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc7), 0, __VA_ARGS__, _gen86_putw(p_pc, imm), 2)))
#define gen86_movl_imm_mod(p_pc, gen_modrm, imm, ...) /* movl $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xc7), 0, __VA_ARGS__, _gen86_putl(p_pc, imm), 4)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movq_imm_mod(p_pc, gen_modrm, imm, ...) /* movq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xc7), 0, __VA_ARGS__, _gen86_putsl(p_pc, imm), 4))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_testb_imm_mod(p_pc, gen_modrm, imm, ...)  /* testb $imm, ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define _gen86_testw_imm_mod(p_pc, gen_modrm, imm, ...) /* testw $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
...
#define _gen86_testl_imm_mod(p_pc, gen_modrm, imm, ...) /* testl $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
...
#if LIBGEN86_TARGET_BITS == 64
#define _gen86_testq_imm_mod(p_pc, gen_modrm, imm, ...) /* testq $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 0, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
...
#define gen86_notb_mod(p_pc, gen_modrm, ...)  /* notb  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_notw_mod(p_pc, gen_modrm, ...)  /* notw  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_notl_mod(p_pc, gen_modrm, ...)  /* notl  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_negb_mod(p_pc, gen_modrm, ...)  /* negb  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_negw_mod(p_pc, gen_modrm, ...)  /* negw  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_negl_mod(p_pc, gen_modrm, ...)  /* negl  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_mulb_mod(p_pc, gen_modrm, ...)  /* mulb  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_mulw_mod(p_pc, gen_modrm, ...)  /* mulw  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_mull_mod(p_pc, gen_modrm, ...)  /* mull  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_imulb_mod(p_pc, gen_modrm, ...) /* imulb ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_imulw_mod(p_pc, gen_modrm, ...) /* imulw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_imull_mod(p_pc, gen_modrm, ...) /* imull ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_divb_mod(p_pc, gen_modrm, ...)  /* divb  ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_divw_mod(p_pc, gen_modrm, ...)  /* divw  ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_divl_mod(p_pc, gen_modrm, ...)  /* divl  ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_idivb_mod(p_pc, gen_modrm, ...) /* idivb ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf6), 7, __VA_ARGS__, _gen86_noop, 0))
#define gen86_idivw_mod(p_pc, gen_modrm, ...) /* idivw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_idivl_mod(p_pc, gen_modrm, ...) /* idivl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xf7), 7, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_notq_mod(p_pc, gen_modrm, ...)  /* notq  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_negq_mod(p_pc, gen_modrm, ...)  /* negq  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_mulq_mod(p_pc, gen_modrm, ...)  /* mulq  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_imulq_mod(p_pc, gen_modrm, ...) /* imulq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_divq_mod(p_pc, gen_modrm, ...)  /* divq  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_idivq_mod(p_pc, gen_modrm, ...) /* idivq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xf7), 7, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_incb_mod(p_pc, gen_modrm, ...) /* incb ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xfe), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_incw_mod(p_pc, gen_modrm, ...) /* incw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_incl_mod(p_pc, gen_modrm, ...) /* incl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_decb_mod(p_pc, gen_modrm, ...) /* decb ... */ gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xfe), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_decw_mod(p_pc, gen_modrm, ...) /* decw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 1, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_decl_mod(p_pc, gen_modrm, ...) /* decl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 1, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_incq_mod(p_pc, gen_modrm, ...) /* incq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_decq_mod(p_pc, gen_modrm, ...) /* decq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 1, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_callw_mod(p_pc, gen_modrm, ...)  /* callw  *... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_calll_mod(p_pc, gen_modrm, ...)  /* calll  *... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 2, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lcallw_mod(p_pc, gen_modrm, ...) /* lcallw ...  */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lcalll_mod(p_pc, gen_modrm, ...) /* lcalll ...  */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 3, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_jmpw_mod(p_pc, gen_modrm, ...)   /* jmpw   *... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_jmpl_mod(p_pc, gen_modrm, ...)   /* jmpl   *... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_ljmpw_mod(p_pc, gen_modrm, ...)  /* ljmpw  ...  */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_ljmpl_mod(p_pc, gen_modrm, ...)  /* ljmpl  ...  */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 5, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_pushw_mod(p_pc, gen_modrm, ...)  /* pushw  ...  */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_pushl_mod(p_pc, gen_modrm, ...)  /* pushl  ...  */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb(p_pc, 0xff), 6, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_callq_mod(p_pc, gen_modrm, ...)  /* callq  *... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_lcallq_mod(p_pc, gen_modrm, ...) /* lcallq ...  */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_jmpq_mod(p_pc, gen_modrm, ...)   /* jmpq   *... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_ljmpq_mod(p_pc, gen_modrm, ...)  /* ljmpq  ...  */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_pushq_mod(p_pc, gen_modrm, ...)  /* pushq  ...  */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb(p_pc, 0xff), 6, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_sldt(p_pc, gen_modrm, ...) /* sldt ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x00), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_str(p_pc, gen_modrm, ...)  /* str  ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x00), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_lldt(p_pc, gen_modrm, ...) /* lldt ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x00), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_ltr(p_pc, gen_modrm, ...)  /* ltr  ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x00), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_verr(p_pc, gen_modrm, ...) /* verr ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x00), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_verw(p_pc, gen_modrm, ...) /* verw ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x00), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sgdt(p_pc, gen_modrm, ...) /* sgdt ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_sidt(p_pc, gen_modrm, ...) /* sidt ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_lgdt(p_pc, gen_modrm, ...) /* lgdt ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_lidt(p_pc, gen_modrm, ...) /* lidt ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 3, __VA_ARGS__, _gen86_noop, 0))

#define gen86_smsww(p_pc, gen_modrm, ...) /* smsww ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_smswl(p_pc, gen_modrm, ...) /* smswl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 4, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lmsww(p_pc, gen_modrm, ...) /* lmsww ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lmswl(p_pc, gen_modrm, ...) /* lmswl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 6, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_smswq(p_pc, gen_modrm, ...) /* smswq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0x01), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_lmswq(p_pc, gen_modrm, ...) /* lmswq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0x01), 6, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_invlpg(p_pc, gen_modrm, ...) /* invlpg ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x01), 7, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_lar_mod_r(p_pc, gen_modrm, reg, ...) /* lar ..., %reg */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x02), reg, __VA_ARGS__, _gen86_noop, 0))

#define gen86_lslw_mod_r(p_pc, gen_modrm, reg, ...) /* lslw ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x03), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lsll_mod_r(p_pc, gen_modrm, reg, ...) /* lsll ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x03), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_lslq_mod_r(p_pc, gen_modrm, reg, ...) /* lslq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0x03), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_prefetch(p_pc, gen_modrm, ...)    /* prefetch    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x0d), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_prefetchw(p_pc, gen_modrm, ...)   /* prefetchw   ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x0d), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_prefetchwt1(p_pc, gen_modrm, ...) /* prefetchwt1 ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x0d), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_prefetchnta(p_pc, gen_modrm, ...) /* prefetchnta ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x18), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_prefetcht0(p_pc, gen_modrm, ...)  /* prefetcht0  ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x18), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_prefetcht1(p_pc, gen_modrm, ...)  /* prefetcht1  ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x18), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_prefetcht2(p_pc, gen_modrm, ...)  /* prefetcht2  ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x18), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_cldemote(p_pc, gen_modrm, ...)    /* cldemote    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x1c), 0, __VA_ARGS__, _gen86_noop, 0))

#define gen86_nopw_mod(p_pc, gen_modrm, ...) /* nopw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x1f), 0, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_nopl_mod(p_pc, gen_modrm, ...) /* nopl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x1f), 0, __VA_ARGS__, _gen86_noop, 0)))

#define gen86_mov_cr_mod(p_pc, gen_modrm, crN, ...) /* mov %crN, ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x20), crN, __VA_ARGS__, _gen86_noop, 0))
#define gen86_mov_dr_mod(p_pc, gen_modrm, drN, ...) /* mov ..., %drN */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x21), drN, __VA_ARGS__, _gen86_noop, 0))
#define gen86_mov_mod_cr(p_pc, gen_modrm, crN, ...) /* mov %crN, ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x22), crN, __VA_ARGS__, _gen86_noop, 0))
#define gen86_mov_mod_dr(p_pc, gen_modrm, drN, ...) /* mov ..., %drN */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x23), drN, __VA_ARGS__, _gen86_noop, 0))
#if LIBGEN86_TARGET_BITS == 64
...
#define gen86_cmovccw_mod_r(p_pc, cc, gen_modrm, reg, ...) /* cmovccw ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x40 + (cc)), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_cmovccl_mod_r(p_pc, cc, gen_modrm, reg, ...) /* cmovccl ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x40 + (cc)), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_cmovccq_mod_r(p_pc, cc, gen_modrm, reg, ...) /* cmovccq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0x40 + (cc)), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_setcc_mod(p_pc, cc, gen_modrm, ...) /* setcc ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0x90 + (cc)), 0, __VA_ARGS__, _gen86_noop, 0))
...
#define gen86_btw_r_mod(p_pc, gen_modrm, reg, ...) /* btw %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xa3), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_btl_r_mod(p_pc, gen_modrm, reg, ...) /* btl %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xa3), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_btq_r_mod(p_pc, gen_modrm, reg, ...) /* btq %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xa3), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_shldw_imm_r_mod(p_pc, gen_modrm, imm, reg, ...) /* shldw %cl, %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xa3), reg, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shldl_imm_r_mod(p_pc, gen_modrm, imm, reg, ...) /* shldl %cl, %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xa3), reg, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shldw_cl_r_mod(p_pc, gen_modrm, reg, ...)       /* shldw %cl, %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xa4), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shldl_cl_r_mod(p_pc, gen_modrm, reg, ...)       /* shldl %cl, %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xa4), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_shldq_imm_r_mod(p_pc, gen_modrm, imm, reg, ...) /* shldq %cl, %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xa3), reg, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_shldq_cl_r_mod(p_pc, gen_modrm, reg, ...)       /* shldq %cl, %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xa4), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_rms(p_pc) /* rms */ _gen86_putb2(p_pc, 0x0f, 0xaa)

#define gen86_btsw_r_mod(p_pc, gen_modrm, reg, ...) /* btsw %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xab), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_btsl_r_mod(p_pc, gen_modrm, reg, ...) /* btsl %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xab), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_btsq_r_mod(p_pc, gen_modrm, reg, ...) /* btsq %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xab), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_shrdw_imm_r_mod(p_pc, gen_modrm, imm, reg, ...) /* shrdw %cl, %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xac), reg, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shrdl_imm_r_mod(p_pc, gen_modrm, imm, reg, ...) /* shrdl %cl, %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xac), reg, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_shrdw_cl_r_mod(p_pc, gen_modrm, reg, ...)       /* shrdw %cl, %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xad), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_shrdl_cl_r_mod(p_pc, gen_modrm, reg, ...)       /* shrdl %cl, %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xad), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_shrdq_imm_r_mod(p_pc, gen_modrm, imm, reg, ...) /* shrdq %cl, %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xac), reg, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_shrdq_cl_r_mod(p_pc, gen_modrm, reg, ...)       /* shrdq %cl, %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xad), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */


#define gen86_rdfsbasel(p_pc, reg) /* rdfsbasel %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 0, reg, _gen86_noop, 0))
#define gen86_rdgsbasel(p_pc, reg) /* rdgsbasel %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 1, reg, _gen86_noop, 0))
#define gen86_wrfsbasel(p_pc, reg) /* wrfsbasel %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 2, reg, _gen86_noop, 0))
#define gen86_wrgsbasel(p_pc, reg) /* wrgsbasel %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 3, reg, _gen86_noop, 0))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_rdfsbaseq(p_pc, reg) /* rdfsbaseq %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 0, reg, _gen86_noop, 0))
#define gen86_rdgsbaseq(p_pc, reg) /* rdgsbaseq %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 1, reg, _gen86_noop, 0))
#define gen86_wrfsbaseq(p_pc, reg) /* wrfsbaseq %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 2, reg, _gen86_noop, 0))
#define gen86_wrgsbaseq(p_pc, reg) /* wrgsbaseq %reg */ (_gen86_putb(p_pc, 0xf3), gen86_modrm_r(p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 3, reg, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */


#define gen86_fxsave(p_pc, gen_modrm, ...)     /* fxsave     ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_fxrstor(p_pc, gen_modrm, ...)    /* fxrstor    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_ldmxcsr(p_pc, gen_modrm, ...)    /* ldmxcsr    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 2, __VA_ARGS__, _gen86_noop, 0))
#define gen86_stmxcsr(p_pc, gen_modrm, ...)    /* stmxcsr    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsave(p_pc, gen_modrm, ...)      /* xsave      ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xrstor(p_pc, gen_modrm, ...)     /* xrstor     ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsaveopt(p_pc, gen_modrm, ...)   /* xsaveopt   ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_clflushopt(p_pc, gen_modrm, ...) /* clflushopt ... */ (_gen86_putb(p_pc, 0x66),gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_clflush(p_pc, gen_modrm, ...)    /* clflush    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xae), 7, __VA_ARGS__, _gen86_noop, 0))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_fxsave64(p_pc, gen_modrm, ...)   /* fxsave64   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 0, __VA_ARGS__, _gen86_noop, 0))
#define gen86_fxrstor64(p_pc, gen_modrm, ...)  /* fxrstor64  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 1, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsave64(p_pc, gen_modrm, ...)    /* xsave64    ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xrstor64(p_pc, gen_modrm, ...)   /* xrstor64   ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 5, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsaveopt64(p_pc, gen_modrm, ...) /* xsaveopt64 ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xae), 6, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */
...
#define gen86_imulw_mod_r(p_pc, gen_modrm, reg, ...) /* imulw ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xaf), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_imull_mod_r(p_pc, gen_modrm, reg, ...) /* imull ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xaf), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_imulq_mod_r(p_pc, gen_modrm, reg, ...) /* imulq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xaf), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_cmpxchgb_r_mod(p_pc, gen_modrm, reg, ...) /* cmpxchgb %reg, ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb0), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_cmpxchgw_r_mod(p_pc, gen_modrm, reg, ...) /* cmpxchgw %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb1), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_cmpxchgl_r_mod(p_pc, gen_modrm, reg, ...) /* cmpxchgl %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb1), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_cmpxchgq_r_mod(p_pc, gen_modrm, reg, ...) /* cmpxchgq %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xb1), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_btrw_r_mod(p_pc, gen_modrm, reg, ...) /* btrw %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb3), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_btrl_r_mod(p_pc, gen_modrm, reg, ...) /* btrl %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb3), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_btrq_r_mod(p_pc, gen_modrm, reg, ...) /* btrq %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xb3), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_movzbw_mod_r(p_pc, gen_modrm, reg, ...) /* movzbw ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb6), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movzbl_mod_r(p_pc, gen_modrm, reg, ...) /* movzbl ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb6), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movzwl_mod_r(p_pc, gen_modrm, reg, ...) /* movzwl ..., %reg */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb7), reg, __VA_ARGS__, _gen86_noop, 0))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movzbq_mod_r(p_pc, gen_modrm, reg, ...) /* movzbq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xb6), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_movzwq_mod_r(p_pc, gen_modrm, reg, ...) /* movzwq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xb7), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_movzlq_mod_r gen86_movl_mod_r
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_popcntw_mod_r(p_pc, gen_modrm, reg, ...) /* popcntw ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb8), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_popcntl_mod_r(p_pc, gen_modrm, reg, ...) /* popcntl ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb8), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_popcntq_mod_r(p_pc, gen_modrm, reg, ...) /* popcntq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xb8), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_ud1_mod(p_pc, gen_modrm, reg, ...) /* ud1 ..., %reg */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xb9), reg, __VA_ARGS__, _gen86_noop, 0))


#define gen86_btw_imm_mod(p_pc, gen_modrm, imm, ...)  /* btw    $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btl_imm_mod(p_pc, gen_modrm, imm, ...)  /* btl    $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btsw_imm_mod(p_pc, gen_modrm, imm, ...) /* btsw   $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btsl_imm_mod(p_pc, gen_modrm, imm, ...) /* btsl   $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btrw_imm_mod(p_pc, gen_modrm, imm, ...) /* btrw   $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btrl_imm_mod(p_pc, gen_modrm, imm, ...) /* btrl   $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btcw_imm_mod(p_pc, gen_modrm, imm, ...) /* btcw   $imm, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btcl_imm_mod(p_pc, gen_modrm, imm, ...) /* btcl   $imm, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xba), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1)))
#define gen86_btcw_r_mod(p_pc, gen_modrm, reg, ...)   /* btcw   %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbb), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_btcl_r_mod(p_pc, gen_modrm, reg, ...)   /* btcl   %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbb), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_bsfw_mod_r(p_pc, gen_modrm, reg, ...)   /* bsfw   ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbc), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_bsfl_mod_r(p_pc, gen_modrm, reg, ...)   /* bsfl   ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbc), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_tzcntw_mod_r(p_pc, gen_modrm, reg, ...) /* tzcntw ..., %reg */ (_gen86_putb(p_pc, 0xf3), _gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbc), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_tzcntl_mod_r(p_pc, gen_modrm, reg, ...) /* tzcntl ..., %reg */ (_gen86_putb(p_pc, 0xf3), _gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbc), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_bsrw_mod_r(p_pc, gen_modrm, reg, ...)   /* bsrw   ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbd), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_bsrl_mod_r(p_pc, gen_modrm, reg, ...)   /* bsrl   ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbd), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lzcntw_mod_r(p_pc, gen_modrm, reg, ...) /* lzcntw ..., %reg */ (_gen86_putb(p_pc, 0xf3), _gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbd), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_lzcntl_mod_r(p_pc, gen_modrm, reg, ...) /* lzcntl ..., %reg */ (_gen86_putb(p_pc, 0xf3), _gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbd), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movsbw_mod_r(p_pc, gen_modrm, reg, ...) /* movsbw ..., %reg */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbe), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movsbl_mod_r(p_pc, gen_modrm, reg, ...) /* movsbl ..., %reg */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbe), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movswl_mod_r(p_pc, gen_modrm, reg, ...) /* movswl ..., %reg */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xbf), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xaddb_r_mod(p_pc, gen_modrm, reg, ...)  /* xaddb  %reg, ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc0), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xaddw_r_mod(p_pc, gen_modrm, reg, ...)  /* xaddw  %reg, ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc1), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_xaddl_r_mod(p_pc, gen_modrm, reg, ...)  /* xaddl  %reg, ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc1), reg, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_btq_imm_mod(p_pc, gen_modrm, imm, ...)  /* btq    $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xba), 4, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_btsq_imm_mod(p_pc, gen_modrm, imm, ...) /* btsq   $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xba), 5, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_btrq_imm_mod(p_pc, gen_modrm, imm, ...) /* btrq   $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xba), 6, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_btcq_imm_mod(p_pc, gen_modrm, imm, ...) /* btcq   $imm, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xba), 7, __VA_ARGS__, _gen86_putb(p_pc, imm), 1))
#define gen86_btcq_r_mod(p_pc, gen_modrm, reg, ...)   /* btcq   %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbb), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_bsfq_mod_r(p_pc, gen_modrm, reg, ...)   /* bsfq   ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbc), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_tzcntq_mod_r(p_pc, gen_modrm, reg, ...) /* tzcntq ..., %reg */ (_gen86_putb(p_pc, 0xf3), gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbc), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_bsrq_mod_r(p_pc, gen_modrm, reg, ...)   /* bsrq   ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbd), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_lzcntq_mod_r(p_pc, gen_modrm, reg, ...) /* lzcntq ..., %reg */ (_gen86_putb(p_pc, 0xf3), gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbd), reg, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_movsbq_mod_r(p_pc, gen_modrm, reg, ...) /* movsbq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbe), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_movswq_mod_r(p_pc, gen_modrm, reg, ...) /* movswq ..., %reg */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xbf), reg, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xaddq_r_mod(p_pc, gen_modrm, reg, ...)  /* xaddq  %reg, ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xc1), reg, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#if LIBGEN86_TARGET_BITS == 64
#define gen86_cmpxchg16b_mod(p_pc, gen_modrm, ...) /* cmpxchg16b ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 1, __VA_ARGS__, _gen86_noop, 0))
#else /* LIBGEN86_TARGET_BITS == 64 */
#define gen86_cmpxchg8b_mod(p_pc, gen_modrm, ...) /* cmpxchg8b ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 1, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS != 64 */

#define gen86_xrstors_mod(p_pc, gen_modrm, ...)   /* xrstors   ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsavec_mod(p_pc, gen_modrm, ...)    /* xsavec    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsaves_mod(p_pc, gen_modrm, ...)    /* xsaves    ... */ gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 5, __VA_ARGS__, _gen86_noop, 0))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_xrstors64_mod(p_pc, gen_modrm, ...) /* xrstors64 ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xc7), 3, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsavec64_mod(p_pc, gen_modrm, ...)  /* xsavec64  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xc7), 4, __VA_ARGS__, _gen86_noop, 0))
#define gen86_xsaves64_mod(p_pc, gen_modrm, ...)  /* xsaves64  ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xc7), 5, __VA_ARGS__, _gen86_noop, 0))
#endif /* LIBGEN86_TARGET_BITS == 64 */

#define gen86_rdrandw_mod(p_pc, gen_modrm, ...) /* rdrandw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rdrandl_mod(p_pc, gen_modrm, ...) /* rdrandl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 6, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rdseedw_mod(p_pc, gen_modrm, ...) /* rdseedw ... */ (_gen86_pfx16_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rdseedl_mod(p_pc, gen_modrm, ...) /* rdseedl ... */ (_gen86_pfx32_(p_pc) gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 7, __VA_ARGS__, _gen86_noop, 0)))
#define gen86_rdpidP_mod(p_pc, gen_modrm, ...)  /* rdpidP  ... */ (_gen86_putb(p_pc, 0xf3), gen_modrm((p_pc, 0, _gen86_putb2(p_pc, 0x0f, 0xc7), 7, __VA_ARGS__, _gen86_noop, 0)))
#if LIBGEN86_TARGET_BITS == 64
#define gen86_rdrandq_mod(p_pc, gen_modrm, ...) /* rdrandq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xc7), 6, __VA_ARGS__, _gen86_noop, 0))
#define gen86_rdseedq_mod(p_pc, gen_modrm, ...) /* rdseedq ... */ gen_modrm((p_pc, GEN86_REX_W, _gen86_putb2(p_pc, 0x0f, 0xc7), 7, __VA_ARGS__, _gen86_noop, 0))
...
local Pinstructions = [
	...
	"gen86_adcP_imm_mod",
	"gen86_adcP_imm_r",
	"gen86_adcP_imm8s_mod",
	"gen86_sbbP_r_mod",
	"gen86_sbbP_mod_r",
	"gen86_sbbP_imm_Pax",
	"gen86_sbbP_imm_mod",
	"gen86_sbbP_imm_r",
	"gen86_sbbP_imm8s_mod",
	"gen86_andP_r_mod",
	"gen86_andP_mod_r",
	"gen86_andP_imm_Pax",
	"gen86_andP_imm_mod",
	"gen86_andP_imm_r",
	"gen86_andP_imm8s_mod",
	"gen86_subP_r_mod",
	"gen86_subP_mod_r",
	"gen86_subP_imm_Pax",
	"gen86_subP_imm_mod",
	"gen86_subP_imm_r",
	"gen86_subP_imm8s_mod",
	"gen86_xorP_r_mod",
	"gen86_xorP_mod_r",
	"gen86_xorP_imm_Pax",
	"gen86_xorP_imm_mod",
	"gen86_xorP_imm_r",
	"gen86_xorP_imm8s_mod",
	"gen86_cmpP_r_mod",
	"gen86_cmpP_mod_r",
	"gen86_cmpP_imm_Pax",
	"gen86_cmpP_imm_mod",
	"gen86_cmpP_imm_r",
	"gen86_cmpP_imm8s_mod",
	"gen86_incP_r",
	"gen86_decP_r",
	"gen86_pushP_r",
	"gen86_popP_r",
	"gen86_pushP_imm",
	"gen86_pushP_imm8s",
	"gen86_imulP_imm_mod_r",
	"gen86_imulP_imm8s_mod_r",
	"gen86_testP_r_mod",
	"gen86_xchgP_r_mod",
	"gen86_movP_r_mod",
	"gen86_movP_mod_r",
	...
	"gen86_cmovccP_r_r",
	"gen86_btP_r_mod",
	"gen86_shldP_imm_r_mod",
	"gen86_shldP_cl_r_mod",
	"gen86_btsP_r_mod",
	"gen86_shrdP_imm_r_mod",
	"gen86_shrdP_cl_r_mod",
	"gen86_rdfsbaseP",
	"gen86_rdgsbaseP",
	"gen86_wrfsbaseP",
	"gen86_wrgsbaseP",
	"gen86_imulP_mod_r",
	"gen86_cmpxchgP_r_mod",
	"gen86_btrP_r_mod",
	"gen86_popcntP_mod_r",
	"gen86_btP_imm_mod",
	"gen86_btsP_imm_mod",
...
function printPinstructions(N, Nax) {
	local longestName = Pinstructions.each.length > ...;
	for (local i: Pinstructions)
		print("#define ", i.ljust(longestName), " ", i.replace("Pax", Nax).replace("P", N));
}

print("#if LIBGEN86_TARGET_BITS == 64");
printPinstructions("q", "rax");
print("#elif LIBGEN86_TARGET_BITS == 32");
printPinstructions("l", "eax");
print("#else /" "* LIBGEN86_TARGET_BITS == ... *" "/");
printPinstructions("w", "ax");
print("#endif /" "* LIBGEN86_TARGET_BITS != ... *" "/");
]]]*/
#if LIBGEN86_TARGET_BITS == 64
#define gen86_movzbP_mod_r      gen86_movzbq_mod_r
#define gen86_movzwP_mod_r      gen86_movzwq_mod_r
#define gen86_movzlP_mod_r      gen86_movzlq_mod_r
...
#define gen86_addP_imm_r        gen86_addq_imm_r
...
#define gen86_orP_imm_r         gen86_orq_imm_r
...
#define gen86_adcP_imm_r        gen86_adcq_imm_r
...
#define gen86_sbbP_imm_r        gen86_sbbq_imm_r
...
#define gen86_andP_imm_r        gen86_andq_imm_r
...
#define gen86_subP_imm_r        gen86_subq_imm_r
...
#define gen86_xorP_imm_r        gen86_xorq_imm_r
...
#define gen86_cmpP_imm_r        gen86_cmpq_imm_r
...
#define gen86_testP_imm_r       gen86_testq_imm_r
...
#define gen86_movzlP_mod_r      gen86_movzll_mod_r
#define gen86_movsbP_mod_r      gen86_movsbl_mod_r
#define gen86_movswP_mod_r      gen86_movswl_mod_r
#define gen86_movslP_mod_r      gen86_movsll_mod_r
...
#define gen86_addP_imm_r        gen86_addl_imm_r
...
#define gen86_orP_imm_r         gen86_orl_imm_r
...
#define gen86_adcP_imm_r        gen86_adcl_imm_r
...
#define gen86_sbbP_imm_r        gen86_sbbl_imm_r
...
#define gen86_andP_imm_r        gen86_andl_imm_r
...
#define gen86_subP_imm_r        gen86_subl_imm_r
...
#define gen86_xorP_imm_r        gen86_xorl_imm_r
...
#define gen86_cmpP_imm_r        gen86_cmpl_imm_r
...
#define gen86_testP_imm_r       gen86_testl_imm_r
...
#define gen86_movzwP_mod_r      gen86_movzww_mod_r
#define gen86_movzlP_mod_r      gen86_movzlw_mod_r
#define gen86_movsbP_mod_r      gen86_movsbw_mod_r
#define gen86_movswP_mod_r      gen86_movsww_mod_r
#define gen86_movslP_mod_r      gen86_movslw_mod_r
...
#define gen86_addP_imm_r        gen86_addw_imm_r
...
#define gen86_orP_imm_r         gen86_orw_imm_r
...
#define gen86_adcP_imm_r        gen86_adcw_imm_r
...
#define gen86_sbbP_imm_r        gen86_sbbw_imm_r
...
#define gen86_andP_imm_r        gen86_andw_imm_r
...
#define gen86_subP_imm_r        gen86_subw_imm_r
...
#define gen86_xorP_imm_r        gen86_xorw_imm_r
...
#define gen86_cmpP_imm_r        gen86_cmpw_imm_r
...
#define gen86_testP_imm_r       gen86_testw_imm_r
...
#define gen86_movP_cr_mod       gen86_movw_cr_mod
#define gen86_movP_dr_mod       gen86_movw_dr_mod
#define gen86_movP_mod_cr       gen86_movw_mod_cr
#define gen86_movP_mod_dr       gen86_movw_mod_dr
...
#define gen86_rdfsbaseP         gen86_rdfsbasew
#define gen86_rdgsbaseP         gen86_rdgsbasew
#define gen86_wrfsbaseP         gen86_wrfsbasew
#define gen86_wrgsbaseP         gen86_wrgsbasew
...
#define gen86_bswapP            gen86_bswapw
#endif /* LIBGEN86_TARGET_BITS != ... */
/*[[[end]]]*/
